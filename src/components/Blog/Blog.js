    ...
    return (
        <section className="bg-gray-800 text-gray-100 ">
            <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
                ...
                <Lottie className='faqslogo' animationData={faqs} loop={true} />
                <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
                    ...
                    <details>
                        <summary className="py-2 outline-none cursor-pointer focus:underline">
                            What is useHref()?</summary>
                        <div className="px-4 pb-4 space-y-2">
                            <p>href is html anchor tag attribute to navigate to another page. Here a new page will be loaded.

                                RouterLink is used to achieve the same functionality but angular 2 or above are single page applications, where the page should not reload. RouterLink navigates to New Url and the component is rendered in place of routeroutlet without reloading the page.</p>
                        </div>
                    </details>
                </div>
            </div>
